...
fn parse_cb(cb: u8) -> io::Result<(MouseEventKind, KeyModifiers)> {
    ...
    let kind = match (button_number, dragging) {
        ...
        (8, false) => MouseEventKind::Down(MouseButton::Mouse4),
        (9, false) => MouseEventKind::Down(MouseButton::Mouse5),
        (8, true) => MouseEventKind::Drag(MouseButton::Mouse4),
        (9, true) => MouseEventKind::Drag(MouseButton::Mouse5),
