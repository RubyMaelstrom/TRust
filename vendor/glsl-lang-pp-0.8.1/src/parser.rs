...
pub(crate) type SyntaxNode = rowan::SyntaxNode<PreprocessorLang>;
pub(crate) type SyntaxToken = rowan::SyntaxToken<PreprocessorLang>;
...
impl<'i, 'cache> ParserRun<'i, 'cache> {
    ...
    fn text(&self, token: lexer::TextToken) -> Unescaped<'_> {
