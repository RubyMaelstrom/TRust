...
pub struct GlyphCacheKey {
    ...
    pub hinted: bool,
    /// Policy used for hinted outline glyphs.
    pub hinting_mode: crate::HintingMode,
...
impl GlyphCacheKey {
    ...
    pub fn new(
        ...
        Self {
            ...
            hinted,
            hinting_mode: crate::HintingMode::default(),
...
impl PartialEq for GlyphCacheKey {
    ...
    fn eq(&self, other: &Self) -> bool {
        self.glyph_id == other.glyph_id
            ...
            && (!self.hinted || self.hinting_mode == other.hinting_mode)
